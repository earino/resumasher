...
[![Tests: 250 passing](https://img.shields.io/badge/tests-250%20passing-brightgreen.svg)](https://github.com/earino/resumasher/tree/main/tests)
...
```bash
# Run the test suite (250 tests, ~5 seconds)
