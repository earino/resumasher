...
[![Tests: 268 passing](https://img.shields.io/badge/tests-268%20passing-brightgreen.svg)](https://github.com/earino/resumasher/tree/main/tests)
...
```bash
# Run the test suite (268 tests, ~5 seconds)
